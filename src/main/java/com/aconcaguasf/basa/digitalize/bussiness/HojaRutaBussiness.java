...
public class HojaRutaBussiness {
    ...
    public List<ResponseDTO> findListReqByHdr(String numHdr) {
        ...
        List<RequerimientoHojaRuta> requerimientoHojaRuta = reqHojaRutaRepository.findAllByIdHojaRuta(hojaRuta.getId(), Arrays.asList(1,3));
    ...
    public RequerimientoHdrDTO findReqHdr(Long idReq) {
        ...
        requerimientoHdrDTO.setFechaEntrega(StringHelper.getInstance().dateToString(operacion.getFechaEntrega(), "dd/mm/yyyy"));
    ...
    public ResponseDTO generateHdr(String numHdr, List<String> numReqList) {
        ...
        if (!numHdr.equalsIgnoreCase("0")) {
            ...
            List<RequerimientoHojaRuta> requerimientoHojaRutaList = reqHojaRutaRepository.findAllByIdHojaRuta(oldHdr.getId(), Arrays.asList(1,3));
    ...
    public boolean ckeckReqAllIncl(String numHdr, List<String> numReqList) {
        ...
        if (!numHdr.equalsIgnoreCase("0")) {
            ...
            List<RequerimientoHojaRuta> listRhdr = reqHojaRutaRepository.findAllByIdHojaRuta(hojaRutaRepository.findHdrByNumero(numHdr).getId(), Arrays.asList(1,3));
