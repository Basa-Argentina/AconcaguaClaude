...
import com.aconcaguasf.basa.digitalize.util.Pair;
...
public class RequerimientoBussiness {
    ...
    public ResponseDTO matchElementsRequerimientos(List<String> elementos, String nroHdR) {
        ...
        List<RequerimientoHojaRuta> requerimientoHojaRutas =
                reqHojaRutaRepository.findAllByIdHojaRuta(hojaRutaRepository.findHdrByNumero(nroHdR).getId(), Arrays.asList(1,3));
    ...
    public ResponseDTO matchRemitosRequerimientos(List<String> remitosList, String nroHdR) {
        List<ResponseDTO> responseList = new ArrayList<>();
        List<RequerimientoHojaRuta> requerimientoHojaRutas = reqHojaRutaRepository.findAllByIdHojaRuta(hojaRutaRepository.findHdrByNumero(nroHdR).getId(), Arrays.asList(1,3));
