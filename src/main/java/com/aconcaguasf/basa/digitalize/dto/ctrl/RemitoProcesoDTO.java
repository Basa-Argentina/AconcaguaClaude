...
public class RemitoProcesoDTO {
    ...
    private List<ElementoRemito> elementosDeBaja;
    ...
    public List<ElementoRemito> getElementosDeBaja() {
        return elementosDeBaja;
    }

    public void setElementosDeBaja(List<ElementoRemito> elementosDeBaja) {
        this.elementosDeBaja = elementosDeBaja;
    }
    public void addElementosDeBaja(ElementoRemito elementoRemito){
        if (this.elementosDeBaja == null)
            this.elementosDeBaja = new ArrayList<>();
        this.elementosDeBaja.add(elementoRemito);
    }
