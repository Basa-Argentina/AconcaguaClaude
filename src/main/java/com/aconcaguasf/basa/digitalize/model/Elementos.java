...
public class Elementos {
    ...
    @Column(nullable = false)
    private String ingreso_por_GyC;
    ...
    public String getIngresoGyC() {
        return ingreso_por_GyC;
    }

    public void setIngresoGyC(String ingreso_por_GyC) {
        this.ingreso_por_GyC = ingreso_por_GyC;
    }

    public String getRemitoBaja() {
        return remitoBaja;
    }
