    ...
    $scope.buscarRemito = function (codigo) {
        remitoFactory.getRemitoProceso(codigo)
            .then(() => {
                ...
                if ($scope.remitoProceso.elementos_de_baja && $scope.remitoProceso.elementos_de_baja.length > 0) {
                    messageFactory.errorAlert('Existen Elementos Dados de Baja en La Lectura Ingresada');
